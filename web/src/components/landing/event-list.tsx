...
const EventList = () => {
    ...
    return (
        <section className="min-h-screen py-20 px-4 sm:px-10  mx-auto grid grid-cols-1 sm:grid-cols-3 gap-16 relative bg-[url('/assets/wth-bg/3.svg')] bg-[size:100%_auto] bg-repeat-y">
